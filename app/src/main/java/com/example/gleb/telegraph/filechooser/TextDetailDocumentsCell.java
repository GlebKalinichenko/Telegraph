...
public class TextDetailDocumentsCell extends FrameLayout {
    ...
    public TextDetailDocumentsCell(Context context) {
        ...
        layoutParams.topMargin = FileChooserUtilities.dp(10);
        layoutParams.leftMargin = FileChooserUtilities.dp(71);
        layoutParams.rightMargin = FileChooserUtilities.dp(16);
        ...
        layoutParams.width = LayoutParams.WRAP_CONTENT;
        layoutParams.height = LayoutParams.WRAP_CONTENT;
        layoutParams.topMargin = FileChooserUtilities.dp(35);
        layoutParams.leftMargin = FileChooserUtilities.dp(71);
        layoutParams.rightMargin = FileChooserUtilities.dp(16);
        layoutParams.gravity = Gravity.LEFT;
        ...
        layoutParams.width = FileChooserUtilities.dp(40);
        layoutParams.height = FileChooserUtilities.dp(40);
        layoutParams.leftMargin = FileChooserUtilities.dp(16);
        layoutParams.rightMargin = FileChooserUtilities.dp(0);
        ...
        layoutParams.width = FileChooserUtilities.dp(22);
        layoutParams.height = FileChooserUtilities.dp(22);
        layoutParams.topMargin = FileChooserUtilities.dp(34);
        layoutParams.leftMargin = FileChooserUtilities.dp(38) ;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(FileChooserUtilities.dp(64), MeasureSpec.EXACTLY));
    }
